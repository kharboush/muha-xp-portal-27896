        ...
        <section>
          ...
          <div className="space-y-3">
            <div className="grid grid-cols-[1fr_2fr] gap-4 items-start">
              ...
              <div style={{ color: "#FFD700", fontWeight: 700 }}>Георги Гидиков</div>
            </div>
            <div className="grid grid-cols-[1fr_2fr] gap-4 items-start">
              <div className="text-right text-gray-500 font-medium">Продуцент</div>
              <div style={{ color: "#FFD700", fontWeight: 700 }}>Ивана Каблешкова</div>
            </div>
            <div className="grid grid-cols-[1fr_2fr] gap-4 items-start">
              <div className="text-right text-gray-500 font-medium">Първи ас. реж.</div>
              <div style={{ color: "#FFD700", fontWeight: 700 }}>Асен Симеонов</div>
            </div>
            <div className="grid grid-cols-[1fr_2fr] gap-4 items-start">
              <div className="text-right text-gray-500 font-medium">Втори ас. реж.</div>
              <div style={{ color: "#FFD700", fontWeight: 700 }}>Александър Паунов</div>
            </div>
            <div className="grid grid-cols-[1fr_2fr] gap-4 items-start">
              <div className="text-right text-gray-500 font-medium">Първи ас. камера</div>
              <div style={{ color: "#FFD700", fontWeight: 700 }}>Елица Стефанова</div>
            </div>
            <div className="grid grid-cols-[1fr_2fr] gap-4 items-start">
              <div className="text-right text-gray-500 font-medium">Steady cam op</div>
              <div style={{ color: "#FFD700", fontWeight: 700 }}>Ерик Бассан</div>
            </div>
            <div className="grid grid-cols-[1fr_2fr] gap-4 items-start">
              <div className="text-right text-gray-500 font-medium">Гафер</div>
              <div style={{ color: "#FFD700", fontWeight: 700 }}>Георги Гвоздев</div>
            </div>
            <div className="grid grid-cols-[1fr_2fr] gap-4 items-start">
              <div className="text-right text-gray-500 font-medium">Осветител</div>
              <div style={{ color: "#FFD700", fontWeight: 700 }}>Петър Райжеков</div>
            </div>
            <div className="grid grid-cols-[1fr_2fr] gap-4 items-start">
              <div className="text-right text-gray-500 font-medium">Осветител/втори ас. камера</div>
              <div style={{ color: "#FFD700", fontWeight: 700 }}>Валентина Николова</div>
            </div>
            <div className="grid grid-cols-[1fr_2fr] gap-4 items-start">
              <div className="text-right text-gray-500 font-medium">Осветител/Grip</div>
              <div style={{ color: "#FFD700", fontWeight: 700 }}>Владо Вълков</div>
            </div>
            <div className="grid grid-cols-[1fr_2fr] gap-4 items-start">
              <div className="text-right text-gray-500 font-medium">Звук</div>
              <div style={{ color: "#FFD700", fontWeight: 700 }}>Пресиан Димитров</div>
            </div>
            <div className="grid grid-cols-[1fr_2fr] gap-4 items-start">
              <div className="text-right text-gray-500 font-medium">Звук</div>
              <div style={{ color: "#FFD700", fontWeight: 700 }}>Алекс Димитров</div>
            </div>
            <div className="grid grid-cols-[1fr_2fr] gap-4 items-start">
              <div className="text-right text-gray-500 font-medium">Скриптьр</div>
              <div style={{ color: "#FFD700", fontWeight: 700 }}>Gabriela Pometkova</div>
            </div>
            <div className="grid grid-cols-[1fr_2fr] gap-4 items-start">
              <div className="text-right text-gray-500 font-medium">Сценография</div>
              <div style={{ color: "#FFD700", fontWeight: 700 }}>Шани Илиева</div>
            </div>
            <div className="grid grid-cols-[1fr_2fr] gap-4 items-start">
              <div className="text-right text-gray-500 font-medium">Сценография</div>
              <div style={{ color: "#FFD700", fontWeight: 700 }}>Кардам Георгиев</div>
            </div>
            <div className="grid grid-cols-[1fr_2fr] gap-4 items-start">
              <div className="text-right text-gray-500 font-medium">Грим и коса</div>
              <div style={{ color: "#FFD700", fontWeight: 700 }}>Деница Петрова-Божинова</div>
            </div>
            <div className="grid grid-cols-[1fr_2fr] gap-4 items-start">
              <div className="text-right text-gray-500 font-medium">Гардероб на терен</div>
              <div style={{ color: "#FFD700", fontWeight: 700 }}>Валентина Георгиева</div>
            </div>
            <div className="grid grid-cols-[1fr_2fr] gap-4 items-start">
              <div className="text-right text-gray-500 font-medium">Гардероб</div>
              <div style={{ color: "#FFD700", fontWeight: 700 }}>Борислав Стаменов</div>
            </div>
            <div className="grid grid-cols-[1fr_2fr] gap-4 items-start">
              <div className="text-right text-gray-500 font-medium">PA n grip</div>
              <div style={{ color: "#FFD700", fontWeight: 700 }}>Любен Краен</div>
            </div>
            <div className="grid grid-cols-[1fr_2fr] gap-4 items-start">
              <div className="text-right text-gray-500 font-medium">Animal handler</div>
              <div style={{ color: "#FFD700", fontWeight: 700 }}>Петко Лазаров</div>
            </div>
            <div className="grid grid-cols-[1fr_2fr] gap-4 items-start">
              <div className="text-right text-gray-500 font-medium">Визуални ефекти</div>
              <div style={{ color: "#FFD700", fontWeight: 700 }}>Калина Александрова</div>
            </div>
            <div className="grid grid-cols-[1fr_2fr] gap-4 items-start">
              <div className="text-right text-gray-500 font-medium">Счетоводител</div>
              <div style={{ color: "#FFD700", fontWeight: 700 }}>Наталия Нанчева</div>
            </div>
            <div className="grid grid-cols-[1fr_2fr] gap-4 items-start">
              <div className="text-right text-gray-500 font-medium">Монтаж</div>
              <div style={{ color: "#FFD700", fontWeight: 700 }}>Габриела Пометкова, Никола Димов</div>
            </div>
            <div className="grid grid-cols-[1fr_2fr] gap-4 items-start">
              <div className="text-right text-gray-500 font-medium">Цветове</div>
              <div style={{ color: "#FFD700", fontWeight: 700 }}>Никола Димов</div>
            </div>
            <div className="grid grid-cols-[1fr_2fr] gap-4 items-start">
              <div className="text-right text-gray-500 font-medium">Звук</div>
              <div style={{ color: "#FFD700", fontWeight: 700 }}>Тома Тодоров</div>
            </div>
            <div className="grid grid-cols-[1fr_2fr] gap-4 items-start">
              <div className="text-right text-gray-500 font-medium">Музика</div>
              <div style={{ color: "#FFD700", fontWeight: 700 }}>Деян Славчев</div>
            </div>
            <div className="grid grid-cols-[1fr_2fr] gap-4 items-start">
              <div className="text-right text-gray-500 font-medium">Title</div>
              <div style={{ color: "#FFD700", fontWeight: 700 }}>Бояна Войнова</div>
            </div>
            <div className="grid grid-cols-[1fr_2fr] gap-4 items-start">
              <div className="text-right text-gray-500 font-medium">Плакат</div>
              <div style={{ color: "#FFD700", fontWeight: 700 }}>Антония Данаилова</div>
            </div>
            <div className="grid grid-cols-[1fr_2fr] gap-4 items-start">
              <div className="text-right text-gray-500 font-medium">Сайт</div>
              <div style={{ color: "#FFD700", fontWeight: 700 }}>Антон Харбуш</div>
            </div>
            <div className="grid grid-cols-[1fr_2fr] gap-4 items-start">
              <div className="text-right text-gray-500 font-medium">Транспорт</div>
              <div style={{ color: "#FFD700", fontWeight: 700 }}>Лиа Манчева</div>
            </div>
            <div className="grid grid-cols-[1fr_2fr] gap-4 items-start">
              <div className="text-right text-gray-500 font-medium">Транспорт мениджър</div>
              <div style={{ color: "#FFD700", fontWeight: 700 }}>Ахинора Каблешкова</div>
            </div>
            ...
            <div className="pt-4 mt-6" style={{ borderTop: "2px solid #FFD700" }}>
              ...
              <div className="space-y-2">
                <div style={{ color: "#FFD700", fontWeight: 700 }}>Даниел Кукушев</div>
                <div style={{ color: "#FFD700", fontWeight: 700 }}>Елеонора Иванова</div>
                <div style={{ color: "#FFD700", fontWeight: 700 }}>Свежен Младенов</div>
                <div style={{ color: "#FFD700", fontWeight: 700 }}>Стефан Денолюбов</div>
              </div>
            </div>
            ...
            <div className="pt-4 mt-6">
              <div className="grid grid-cols-[1fr_2fr] gap-4 items-start">
                ...
                <div style={{ color: "#FFD700", fontWeight: 700 }}>Слава Миланова</div>
              </div>
            </div>

            <div className="pt-4 mt-6">
              <h3 className="text-xl font-bold mb-4" style={{ color: "#000000", fontFamily: '"Public Sans", sans-serif', fontWeight: 900, fontStyle: "italic" }}>МАСОВКА</h3>
              <div className="space-y-2">
                <div style={{ color: "#FFD700", fontWeight: 700 }}>Сибела Чинарева</div>
                <div style={{ color: "#FFD700", fontWeight: 700 }}>Георги Желев</div>
              </div>
            </div>
